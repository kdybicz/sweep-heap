...
const triggerClassName =
  "inline-flex max-w-full cursor-pointer list-none items-center gap-2 rounded-[var(--radius-md)] border border-[var(--stroke-soft)] bg-[var(--surface)] px-2.5 py-2 text-left text-sm font-semibold text-[var(--ink)] transition hover:border-[var(--accent-secondary)] hover:bg-[var(--surface-weak)] [&::-webkit-details-marker]:hidden";
...
export default function HouseholdDropdown({
  ...
  return (
    ...
    >
      <summary className={triggerClassName}>
        <span className="flex min-w-0 items-center gap-2">
          ...
          <span className="flex min-w-0 items-center gap-2.5">
            ...
            <span className="inline-flex shrink-0 translate-y-px items-center rounded-[var(--radius-sm)] border border-[var(--stroke-soft)] bg-[var(--surface-weak)] px-1.5 py-0.5 text-[0.55rem] font-semibold uppercase leading-none tracking-[0.08em] text-[var(--muted)]">
      ...
      <div className="absolute left-0 z-50 mt-2 min-w-56 max-w-[min(20rem,calc(100vw-2rem))] rounded-[var(--radius-lg)] border border-[var(--stroke)] bg-[var(--surface)] py-1 shadow-[var(--shadow-soft)]">
        <div className="border-b border-[var(--stroke-soft)] px-3 py-3">
          <div className="flex min-w-0 items-center gap-2">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[0.62rem] font-semibold uppercase tracking-[0.08em] text-[var(--muted)]">
                Current household
              </div>
            </div>
          </div>
