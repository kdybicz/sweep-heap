        ...
        {themeOptions.map((themeOption) => {
          ...
          return (
            <label
              ...
              className={`flex cursor-pointer flex-col gap-2 rounded-[var(--radius-md)] border px-4 py-4 text-left transition ${
                isSelected
                  ? "border-[var(--accent-secondary)] bg-[var(--accent-secondary-soft)] shadow-[0_10px_28px_rgba(217,90,58,0.12)]"
            ...
            >
              <div className="flex items-center justify-between gap-3">
                ...
                <span
                  className={`inline-flex h-5 w-5 items-center justify-center rounded-[var(--radius-sm)] border ${
                    isSelected
